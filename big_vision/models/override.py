# modified from https://flax.readthedocs.io/en/v0.5.3/_modules/flax/linen/attention.html#MultiHeadDotProductAttention
    ...
    if self.decode:
      ...
      if is_initialized:
        *batch_dims, max_length, num_heads, depth_per_head = (cached_key.value.shape)
        ...
        mask = combine_masks(mask, jnp.broadcast_to(jnp.arange(max_length) <= cur_index, tuple(batch_dims) + (1, 1, max_length)))
